...
Scenario: Successfully update the Clubcard number
  Given I am signed in # need to understand the logic behind "I am signed in" & "I have registered as new user"
...
Scenario Outline: Trying to update the Clubcard number with an invalid Clubcard
...
Scenario: Trying to rename a registered device when access token has expire
