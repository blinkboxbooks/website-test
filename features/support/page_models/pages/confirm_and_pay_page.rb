module PageModels
  class ConfirmAndPayPage < PageModels::BlinkboxbooksPage
    ...
    set_load_checker { |page| (page.has_pay_with_new_card? && page.pay_with_new_card.visible?) || page.has_card_number? || page.has_free_book_message? || page.has_account_credit_payment? }
